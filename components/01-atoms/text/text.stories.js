...
import preformattedTwig from './preformatted/preformatted.twig';

// Data files
import textData from './text/text.yml';
import headingData from './headings/headings.yml';
import preformattedData from './preformatted/preformatted.yml';
...
export const PreformattedExamples = () => `
  ${preformattedTwig(preformattedData)}
`;
