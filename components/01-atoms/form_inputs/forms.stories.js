 ...
 */
export default { title: 'Atoms/Forms Inputs' };

export const checkboxes = () =>
  `<div class="cl-container"><form class="form"> ${checkbox(
    checkboxData,
  )} </form></div>`;
export const radioButtons = () =>
  `<div class="cl-container"><form class="form"> ${radio(
    radioData,
  )} </form></div>`;
export const selectDropdowns = () =>
  `<div class="cl-container"><form class="form"> ${select(
    selectOptionsData,
  )} </form></div>`;
export const textfieldsExamples = () =>
  `<div class="cl-container"><form class="form"> ${textfields(
    {},
  )} </form></div>`;
